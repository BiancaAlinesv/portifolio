  ...
  <div class="container">
    ...
    <div class="carousel" data-carousel data-per-page="2">
      <div class="carousel-track">
        <?php
        $carouselProjects = array_slice($projects, 0, 6);
        $chunks = array_chunk($carouselProjects, 2);
        foreach ($chunks as $pageIdx => $pair): ?>
        <div class="carousel-page" data-slide="<?= $pageIdx ?>">
          <?php foreach ($pair as $i => $project): ?>
          <div class="carousel-card">
            <div class="project-number" aria-hidden="true"><?= str_pad((string)($pageIdx * 2 + $i + 1), 3, '0', STR_PAD_LEFT) ?></div>
    ...
    <div class="projects-more">
      <a href="projetos.php" class="btn btn-ghost">Todos os projetos →</a>
    </div>
    <?php endif; ?>
  </div>
</section>
